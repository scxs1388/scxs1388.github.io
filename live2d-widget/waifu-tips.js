...
function loadWidget(config) {
	...
	async function loadlive2dPixi(jsonPath) {
		...
		model.scale.set(-ratio / 1.33, ratio / 1.33);
	...
	async function loadModel(modelId, modelTexturesId, message) {
		...
		// loadlive2dPixi(`live2d-widget/assets/Coccolo/model.model.json`);
		loadlive2dPixi(`/live2d-widget/assets/hutaoyao-live2d/hutao.model3.json`);
		// loadlive2dPixi(`live2d-widget/assets/21miku_night/21miku_night.model3.json`);
		// loadlive2d("live2d", `live2d-widget/assets/Coccolo/model.model.json`);
		// loadlive2d("lpk", `live2d-widget/assets/2515599228/2515599228.lpk`);
		// loadlive2d("live2d", `live2d-widget/assets/haru/haru.model.json`);
		// if (useCDN) {
